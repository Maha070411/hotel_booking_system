...
public class HotelController {
    ...
    public ResponseEntity<List<Hotel>> getHotels(
        ...
        if (query != null || location != null || checkIn != null || checkOut != null || minPrice != null || maxPrice != null || (amenities != null && !amenities.isEmpty())) {
            return ResponseEntity.ok(hotelService.advancedSearch(query, location, checkIn, checkOut, minPrice, maxPrice, amenities));
        }
