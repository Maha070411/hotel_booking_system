    ...
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '80vh', padding: '1rem' }}>
      <div className="card booking-card-premium" style={{ maxWidth: '450px', width: '100%', padding: '3rem', borderRadius: '24px', textAlign: 'center', position: 'relative' }}>
        ...
        <div style={{ marginBottom: '2rem' }}>
          ...
          <p className="text-muted">Sign in to your account and continue your premium experience.</p>
        </div>
        <form onSubmit={handleLogin} style={{ textAlign: 'left' }}>
          ...
          <button className="search-btn-premium" type="submit" style={{ width: '100%', padding: '1rem', fontSize: '1.1rem' }}>Sign In</button>
        </form>
        <p style={{ marginTop: '2rem', color: '#6B7280', fontSize: '0.95rem' }}>
          Don't have an account? <span style={{ color: 'var(--primary)', fontWeight: '700', cursor: 'pointer' }} onClick={() => navigate('/register')}>Sign Up</span>
        </p>
      </div>
    </div>
  );
