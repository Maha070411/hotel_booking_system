                ...
                <div style={{ flex: 1, minWidth: '250px' }}>
                  ...
                  <div style={{ display: 'flex', gap: '1.5rem', fontSize: '0.9rem' }}>
                    <div>
                      ...
                      <strong>{new Date(booking.checkIn).toLocaleString([], {dateStyle: 'short', timeStyle: 'short'})}</strong>
                    </div>
                    <div>
                      ...
                      <strong>{new Date(booking.checkOut).toLocaleString([], {dateStyle: 'short', timeStyle: 'short'})}</strong>
                    </div>
                    {booking.totalPrice && (
                      <div>
                        <span style={{ color: 'var(--text-muted)', display: 'block', fontSize: '0.75rem', textTransform: 'uppercase', marginBottom: '0.25rem' }}>Total Price</span>
                        <strong style={{ color: '#059669' }}>${booking.totalPrice}</strong>
                      </div>
                    )}
                  </div>
                </div>
